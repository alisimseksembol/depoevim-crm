...
const [customers, setCustomers] = useState([]);
 ...
 const handleSaveCustomer = async () => {
  ...
  const [warehouses, setWarehouses] = useState([
    { id: 1, name: 'ÇEKMEKÖY ŞUBESİ', m3: 6117 },
    { id: 2, name: 'ÜMRANİYE ŞUBESİ', m3: 3724 },
    { id: 3, name: 'KARTAL ŞUBESİ', m3: 3275 },
    { id: 4, name: 'ALT KAYNARCA ŞUBESİ', m3: 481 },
    { id: 5, name: 'ÇINARDERE ŞUBESİ', m3: 581 },
    { id: 6, name: 'YEŞİLBAĞLAR ŞUBESİ', m3: 588 },
    { id: 7, name: 'KURFALI ŞUBESİ', m3: 688 },
    { id: 8, name: 'SAHİL ŞUBESİ', m3: 1043 },
  ]);
  ...
  const handleEditWarehouse = () => {
    ...
    setWarehouses(warehouses.map(w => w.id === editWarehouseData.id ? { ...w, name: editWarehouseData.name, m3: editWarehouseData.m3 } : w));
  ...
  const [blocks, setBlocks] = useState([
    { id: 101, warehouseId: 1, name: 'L BLOK', m3: 369 },
    { id: 102, warehouseId: 1, name: 'K BLOK', m3: 528 },
    { id: 103, warehouseId: 1, name: 'H BLOK', m3: 528 },
    { id: 104, warehouseId: 1, name: 'G BLOK', m3: 534 },
    { id: 105, warehouseId: 1, name: 'F BLOK', m3: 533 },
    { id: 106, warehouseId: 1, name: 'E BLOK', m3: 346 },
    { id: 107, warehouseId: 1, name: 'D BLOK', m3: 952 },
    { id: 108, warehouseId: 1, name: 'C BLOK', m3: 636 },
    { id: 109, warehouseId: 1, name: 'B BLOK', m3: 653 },
    { id: 110, warehouseId: 1, name: 'A BLOK', m3: 983 },
    { id: 200, warehouseId: 2, name: 'H BLOK', m3: 329 },
    { id: 201, warehouseId: 2, name: 'F BLOK', m3: 803 },
    { id: 202, warehouseId: 2, name: 'E BLOK', m3: 650 },
    { id: 203, warehouseId: 2, name: 'D BLOK', m3: 680 },
    { id: 204, warehouseId: 2, name: 'C BLOK', m3: 384 },
    { id: 205, warehouseId: 2, name: 'B BLOK', m3: 389 },
    { id: 206, warehouseId: 2, name: 'A BLOK', m3: 444 },
    { id: 300, warehouseId: 3, name: 'M BLOK', m3: 326 },
    { id: 301, warehouseId: 3, name: 'L BLOK', m3: 377 },
    { id: 302, warehouseId: 3, name: 'K BLOK', m3: 210 },
    { id: 303, warehouseId: 3, name: 'H BLOK', m3: 56 },
    { id: 304, warehouseId: 3, name: 'G BLOK', m3: 160 },
    { id: 305, warehouseId: 3, name: 'F BLOK', m3: 186 },
    { id: 306, warehouseId: 3, name: 'E BLOK', m3: 264 },
    { id: 307, warehouseId: 3, name: 'D BLOK', m3: 218 },
    { id: 308, warehouseId: 3, name: 'C BLOK', m3: 431 },
    { id: 309, warehouseId: 3, name: 'B BLOK', m3: 478 },
    { id: 310, warehouseId: 3, name: 'A BLOK', m3: 528 },
    { id: 400, warehouseId: 4, name: 'X BLOK', m3: 481 },
    { id: 500, warehouseId: 5, name: 'V BLOK', m3: 274 },
    { id: 501, warehouseId: 5, name: 'U BLOK', m3: 309 },
    { id: 600, warehouseId: 6, name: 'M BLOK', m3: 146 },
    { id: 601, warehouseId: 6, name: 'N BLOK', m3: 153 },
    { id: 602, warehouseId: 6, name: 'L BLOK', m3: 268 },
    { id: 700, warehouseId: 7, name: 'K BLOK', m3: 278 },
    { id: 701, warehouseId: 7, name: 'I BLOK', m3: 228 },
    { id: 702, warehouseId: 7, name: 'H BLOK', m3: 222 },
    { id: 800, warehouseId: 8, name: 'D BLOK', m3: 200 },
    { id: 801, warehouseId: 8, name: 'C BLOK', m3: 258 },
    { id: 802, warehouseId: 8, name: 'B BLOK', m3: 314 },
    { id: 803, warehouseId: 8, name: 'A BLOK', m3: 211 },
  ]);
  ...
  const handleEditBlock = () => {
    ...
    setBlocks(blocks.map(b => b.id === editBlockData.id ? { ...b, name: editBlockData.name, m3: editBlockData.m3 } : b));
  ...
  const [rooms, setRooms] = useState([
    ...[
      { n: 'L-801', m: 40 }, { n: 'L-802', m: 18 }, { n: 'L-803', m: 18 }, { n: 'L-804', m: 11 },
      { n: 'L-805', m: 10 }, { n: 'L-806', m: 10 }, { n: 'L-807', m: 25 }, { n: 'L-808', m: 25 },
      { n: 'L-809', m: 10 }, { n: 'L-810', m: 10 }, { n: 'L-811', m: 10 }, { n: 'L-812', m: 10 },
      { n: 'L-813', m: 10 }, { n: 'L-814', m: 10 }, { n: 'L-815', m: 10 }, { n: 'L-816', m: 10 },
      { n: 'L-817', m: 10 }, { n: 'L-818', m: 10 }, { n: 'L-819', m: 13 }, { n: 'L-820', m: 40 },
      { n: 'L-221', m: 10 }, { n: 'L-822', m: 10 }, { n: 'L-823', m: 10 }, { n: 'L-824', m: 10 },
      { n: 'L-825', m: 10 }, { n: 'L-826', m: 9 }, { n: 'L-827', m: 10 }, { n: 'L-828', m: 10 },
      { n: 'L-829', m: 10 },
    ].map((r, i) => ({ id: 101000 + i, blockId: 101, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      ...Array(23).fill(15).map((m, i) => ({ n: `K-${801 + i}`, m })),
      { n: 'K-824', m: 24 }, { n: 'K-825', m: 24 }, { n: 'K-826', m: 15 }, { n: 'K-827', m: 24 },
      { n: 'K-828', m: 24 }, { n: 'K-829', m: 24 }, { n: 'K-830', m: 24 }, { n: 'K-831', m: 45 },
    ].map((r, i) => ({ id: 102000 + i, blockId: 102, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n: 'H-801', m: 20 }, { n: 'H-802', m: 20 }, { n: 'H-803', m: 22 }, { n: 'H-804', m: 22 },
      { n: 'H-805', m: 22 }, { n: 'H-806', m: 22 }, { n: 'H-807', m: 45 }, { n: 'H-808', m: 30 },
      { n: 'H-809', m: 28 }, { n: 'H-810', m: 30 }, { n: 'H-811', m: 30 }, { n: 'H-812', m: 30 },
      { n: 'H-813', m: 30 }, { n: 'H-814', m: 30 }, { n: 'H-815', m: 30 }, { n: 'H-816', m: 30 },
      { n: 'H-817', m: 30 }, { n: 'H-818', m: 30 }, { n: 'H-819', m: 27 },
    ].map((r, i) => ({ id: 103000 + i, blockId: 103, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n: 'G-801', m: 27 }, { n: 'G-802', m: 30 }, { n: 'G-803', m: 30 }, { n: 'G-804', m: 30 },
      { n: 'G-805', m: 30 }, { n: 'G-806', m: 30 }, { n: 'G-807', m: 30 }, { n: 'G-808', m: 30 },
      { n: 'G-809', m: 32 }, { n: 'G-810', m: 27 }, { n: 'G-811', m: 30 }, { n: 'G-812', m: 30 },
      { n: 'G-813', m: 50 }, { n: 'G-814', m: 22 }, { n: 'G-815', m: 22 }, { n: 'G-816', m: 22 },
      { n: 'G-817', m: 22 }, { n: 'G-818', m: 20 }, { n: 'G-819', m: 20 },
    ].map((r, i) => ({ id: 104000 + i, blockId: 104, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n: 'F-801', m: 50 }, { n: 'F-802', m: 15 }, { n: 'F-803', m: 15 }, { n: 'F-804', m: 20 },
      { n: 'F-805', m: 21 }, { n: 'F-806', m: 15 }, { n: 'F-807', m: 15 }, { n: 'F-808', m: 15 },
      { n: 'F-809', m: 20 }, { n: 'F-810', m: 15 }, { n: 'F-811', m: 15 }, { n: 'F-812', m: 15 },
      { n: 'F-813', m: 20 }, { n: 'F-814', m: 15 }, { n: 'F-815', m: 15 }, { n: 'F-816', m: 17 },
      { n: 'F-817', m: 18 }, { n: 'F-818', m: 15 }, { n: 'F-819', m: 15 }, { n: 'F-820', m: 15 },
      { n: 'F-821', m: 15 }, { n: 'F-822', m: 15 }, { n: 'F-823', m: 15 }, { n: 'F-824', m: 15 },
      { n: 'F-825', m: 15 }, { n: 'F-826', m: 15 }, { n: 'F-827', m: 15 }, { n: 'F-828', m: 15 },
      { n: 'F-829', m: 15 }, { n: 'F-830', m: 15 }, { n: 'F-831', m: 15 }, { n: 'F-832', m: 15 },
    ].map((r, i) => ({ id: 105000 + i, blockId: 105, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n: 'E-801', m: 14 }, { n: 'E-802', m: 14 }, { n: 'E-803', m: 14 }, { n: 'E-804', m: 14 },
      { n: 'E-805', m: 14 }, { n: 'E-806', m: 15 }, { n: 'E-807', m: 15 }, { n: 'E-808', m: 14 },
      { n: 'E-809', m: 14 }, { n: 'E-810', m: 14 }, { n: 'E-811', m: 15 }, { n: 'E-812', m: 15 },
      { n: 'E-813', m: 11 }, { n: 'E-814', m: 14 }, { n: 'E-815', m: 14 }, { n: 'E-816', m: 15 },
      { n: 'E-817', m: 12 }, { n: 'E-818', m: 7 }, { n: 'E-819', m: 9 }, { n: 'E-820', m: 15 },
      { n: 'E-821', m: 7 }, { n: 'E-822', m: 9 }, { n: 'E-823', m: 9 }, { n: 'E-824', m: 15 },
      { n: 'E-825', m: 10 }, { n: 'E-826', m: 10 }, { n: 'E-827', m: 10 }, { n: 'E-828', m: 10 },
    ].map((r, i) => ({ id: 106000 + i, blockId: 106, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n: 'D-801', m: 40 }, { n: 'D-802', m: 24 }, { n: 'D-803', m: 25 }, { n: 'D-804', m: 32 },
      { n: 'D-805', m: 31 }, { n: 'D-806', m: 24 }, { n: 'D-807', m: 24 }, { n: 'D-808', m: 21 },
      { n: 'D-809', m: 22 }, { n: 'D-810', m: 23 }, { n: 'D-811', m: 24 }, { n: 'D-812', m: 22 },
      { n: 'D-813', m: 24 }, { n: 'D-814', m: 24 }, { n: 'D-815', m: 23 }, { n: 'D-816', m: 22 },
      { n: 'D-817', m: 27 }, { n: 'D-818', m: 24 }, { n: 'D-819', m: 24 }, { n: 'D-820', m: 27 },
      { n: 'D-821', m: 27 }, { n: 'D-822', m: 26 }, { n: 'D-823', m: 27 }, { n: 'D-824', m: 27 },
      { n: 'D-825', m: 27 }, { n: 'D-826', m: 26 }, { n: 'D-827', m: 26 }, { n: 'D-828', m: 25 },
      { n: 'D-829', m: 27 }, { n: 'D-830', m: 28 }, { n: 'D-831', m: 30 }, { n: 'D-832', m: 28 },
      { n: 'D-833', m: 30 }, { n: 'D-834', m: 32 }, { n: 'D-835', m: 30 }, { n: 'D-836', m: 45 },
    ].map((r, i) => ({ id: 107000 + i, blockId: 107, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n: 'C-801', m: 14 }, { n: 'C-802', m: 14 }, { n: 'C-803', m: 14 }, { n: 'C-804', m: 14 },
      { n: 'C-805', m: 15 }, { n: 'C-806', m: 15 }, { n: 'C-807', m: 14 }, { n: 'C-808', m: 14 },
      { n: 'C-809', m: 13 }, { n: 'C-810', m: 40 }, { n: 'C-811', m: 14 }, { n: 'C-812', m: 14 },
      { n: 'C-813', m: 24 }, { n: 'C-814', m: 23 }, { n: 'C-815', m: 23 }, { n: 'C-816', m: 24 },
      { n: 'C-817', m: 26 }, { n: 'C-818', m: 22 }, { n: 'C-819', m: 24 }, { n: 'C-820', m: 24 },
      { n: 'C-821', m: 24 }, { n: 'C-822', m: 25 }, { n: 'C-823', m: 25 }, { n: 'C-824', m: 24 },
      { n: 'C-825', m: 24 }, { n: 'C-826', m: 22 }, { n: 'C-827', m: 22 }, { n: 'C-828', m: 22 },
      { n: 'C-829', m: 22 }, { n: 'C-830', m: 22 },
    ].map((r, i) => ({ id: 108000 + i, blockId: 108, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n: 'B-801', m: 32 }, { n: 'B-802', m: 27 }, { n: 'B-803', m: 24 }, { n: 'B-804', m: 27 },
      { n: 'B-805', m: 27 }, { n: 'B-806', m: 24 }, { n: 'B-807', m: 24 }, { n: 'B-808', m: 24 },
      { n: 'B-809', m: 24 }, { n: 'B-810', m: 24 }, { n: 'B-811', m: 24 }, { n: 'B-812', m: 24 },
      { n: 'B-813', m: 24 }, { n: 'B-814', m: 24 }, { n: 'B-815', m: 24 }, { n: 'B-816', m: 24 },
      { n: 'B-817', m: 22 }, { n: 'B-818', m: 24 }, { n: 'B-819', m: 23 }, { n: 'B-820', m: 40 },
      { n: 'B-821', m: 14 }, { n: 'B-822', m: 14 }, { n: 'B-823', m: 14 }, { n: 'B-824', m: 14 },
      { n: 'B-825', m: 14 }, { n: 'B-826', m: 14 }, { n: 'B-827', m: 14 }, { n: 'B-828', m: 14 },
      { n: 'B-829', m: 14 }, { n: 'B-830', m: 14 },
    ].map((r, i) => ({ id: 109000 + i, blockId: 109, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n: 'A-801', m: 22 }, { n: 'A-802', m: 27 }, { n: 'A-803', m: 27 }, { n: 'A-804', m: 29 },
      { n: 'A-805', m: 29 }, { n: 'A-806', m: 30 }, { n: 'A-807', m: 30 }, { n: 'A-808', m: 29 },
      { n: 'A-809', m: 29 }, { n: 'A-810', m: 30 }, { n: 'A-811', m: 30 }, { n: 'A-812', m: 29 },
      { n: 'A-813', m: 26 }, { n: 'A-814', m: 28 }, { n: 'A-815', m: 23 }, { n: 'A-816', m: 23 },
      { n: 'A-817', m: 26 }, { n: 'A-818', m: 32 }, { n: 'A-819', m: 23 }, { n: 'A-820', m: 23 },
      { n: 'A-821', m: 22 }, { n: 'A-822', m: 23 }, { n: 'A-823', m: 23 }, { n: 'A-824', m: 23 },
      { n: 'A-825', m: 24 }, { n: 'A-826', m: 22 }, { n: 'A-827', m: 24 }, { n: 'A-828', m: 24 },
      { n: 'A-829', m: 24 }, { n: 'A-830', m: 23 }, { n: 'A-831', m: 23 }, { n: 'A-832', m: 23 },
      { n: 'A-833', m: 23 }, { n: 'A-834', m: 23 }, { n: 'A-835', m: 23 }, { n: 'A-836', m: 23 },
      { n: 'A-837', m: 23 }, { n: 'A-838', m: 23 },
    ].map((r, i) => ({ id: 110000 + i, blockId: 110, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n: 'H-2101', m: 23 }, { n: 'H-2102', m: 25 }, { n: 'H-2103', m: 17 }, { n: 'H-2104', m: 19 },
      { n: 'H-2105', m: 23 }, { n: 'H-2106', m: 27 }, { n: 'H-2107', m: 27 }, { n: 'H-2108', m: 35 },
      { n: 'H-2109', m: 22 }, { n: 'H-2110', m: 20 }, { n: 'H-2111', m: 22 }, { n: 'H-2112', m: 22 },
      { n: 'H-2113', m: 23 }, { n: 'H-2114', m: 12 }, { n: 'H-2115', m: 13 },
    ].map((r, i) => ({ id: 200000 + i, blockId: 200, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n:'F-2101', m:27}, { n:'F-2102', m:27}, { n:'F-2103', m:27}, { n:'F-2104', m:27},
      { n:'F-2105', m:27}, { n:'F-2106', m:27}, { n:'F-2107', m:27}, { n:'F-2108', m:27},
      { n:'F-2109', m:27}, { n:'F-2110', m:23}, { n:'F-2111', m:23}, { n:'F-2112', m:23},
      { n:'F-2113', m:27}, { n:'F-2114', m:25}, { n:'F-2115', m:25}, { n:'F-2116', m:25},
      { n:'F-2117', m:25}, { n:'F-2118', m:25}, { n:'F-2119', m:25}, { n:'F-2120', m:15},
      { n:'F-2121', m:15}, { n:'F-2122', m:15}, { n:'F-2123', m:15}, { n:'F-2124', m:15},
      { n:'F-2125', m:14}, { n:'F-2126', m:15}, { n:'F-2127', m:15}, { n:'F-2128', m:15},
      { n:'F-2129', m:15}, { n:'F-2130', m:15}, { n:'F-2131', m:15}, { n:'F-2132', m:15},
      { n:'F-2133', m:15}, { n:'F-2134', m:15}, { n:'F-2135', m:15}, { n:'F-2136', m:15},
      { n:'F-2137', m:15}, { n:'F-2138', m:15}, { n:'F-2139', m:15}, { n:'F-2140', m:15},
    ].map((r, i) => ({ id: 201000 + i, blockId: 201, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n:'E-2101', m:35}, { n:'E-2102', m:22}, { n:'E-2103', m:18}, { n:'E-2104', m:18},
      { n:'E-2105', m:22}, { n:'E-2106', m:18}, { n:'E-2107', m:18}, { n:'E-2108', m:18},
      { n:'E-2109', m:22}, { n:'E-2110', m:18}, { n:'E-2111', m:18}, { n:'E-2112', m:18},
      { n:'E-2113', m:21}, { n:'E-2114', m:18}, { n:'E-2115', m:18}, { n:'E-2116', m:18},
      { n:'E-2117', m:17}, { n:'E-2118', m:23}, { n:'E-2119', m:25}, { n:'E-2120', m:15},
      { n:'E-2121', m:15}, { n:'E-2122', m:15}, { n:'E-2123', m:15}, { n:'E-2124', m:15},
      { n:'E-2125', m:15}, { n:'E-2126', m:15}, { n:'E-2127', m:15}, { n:'E-2128', m:15},
      { n:'E-2129', m:15}, { n:'E-2130', m:15}, { n:'E-2131', m:15}, { n:'E-2132', m:15},
      { n:'E-2133', m:15}, { n:'E-2134', m:15}, { n:'E-2135', m:40},
    ].map((r, i) => ({ id: 202000 + i, blockId: 202, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n:'D-2101', m:42}, { n:'D-2102', m:24}, { n:'D-2103', m:9},  { n:'D-2104', m:9},
      { n:'D-2105', m:29}, { n:'D-2106', m:21}, { n:'D-2107', m:24}, { n:'D-2108', m:24},
      { n:'D-2109', m:26}, { n:'D-2110', m:25}, { n:'D-2111', m:28}, { n:'D-2112', m:29},
      { n:'D-2113', m:29}, { n:'D-2114', m:28}, { n:'D-2115', m:28}, { n:'D-2116', m:21},
      { n:'D-2117', m:25}, { n:'D-2118', m:35}, { n:'D-2119', m:45}, { n:'D-2120', m:21},
      { n:'D-2121', m:25}, { n:'D-2122', m:26}, { n:'D-2123', m:22}, { n:'D-2124', m:21},
      { n:'D-2125', m:14}, { n:'D-2126', m:13}, { n:'D-2127', m:13}, { n:'D-2128', m:15}
    ].map((r, i) => ({ id: 203000 + i, blockId: 203, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n:'C-2101', m:20}, { n:'C-2102', m:20}, { n:'C-2103', m:21}, { n:'C-2104', m:21},
      { n:'C-2105', m:20}, { n:'C-2106', m:22}, { n:'C-2107', m:21}, { n:'C-2108', m:21},
      { n:'C-2109', m:21}, { n:'C-2110', m:21}, { n:'C-2111', m:21}, { n:'C-2112', m:16},
      { n:'C-2113', m:21}, { n:'C-2114', m:21}, { n:'C-2115', m:16}, { n:'C-2116', m:15},
      { n:'C-2117', m:15}, { n:'C-2118', m:15}, { n:'C-2119', m:15}, { n:'C-2120', m:15},
      { n:'C-2121', m:15}, { n:'C-2122', m:15}, { n:'C-2123', m:15}
    ].map((r, i) => ({ id: 204000 + i, blockId: 204, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n:'B-2101', m:19}, { n:'B-2102', m:21}, { n:'B-2103', m:21}, { n:'B-2104', m:20},
      { n:'B-2105', m:22}, { n:'B-2106', m:22}, { n:'B-2107', m:22}, { n:'B-2108', m:22},
      { n:'B-2109', m:22}, { n:'B-2110', m:21}, { n:'B-2111', m:22}, { n:'B-2112', m:16},
      { n:'B-2113', m:15}, { n:'B-2114', m:15}, { n:'B-2115', m:15}, { n:'B-2116', m:15},
      { n:'B-2117', m:15}, { n:'B-2118', m:15}, { n:'B-2119', m:15}, { n:'B-2120', m:15},
      { n:'B-2121', m:13}, { n:'B-2122', m:13}
    ].map((r, i) => ({ id: 205000 + i, blockId: 205, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n:'A-2101', m:40}, { n:'A-2102', m:25}, { n:'A-2103', m:23}, { n:'A-2104', m:23},
      { n:'A-2105', m:40}, { n:'A-2106', m:25}, { n:'A-2107', m:23}, { n:'A-2108', m:23},
      { n:'A-2109', m:23}, { n:'A-2110', m:21}, { n:'A-2111', m:15}, { n:'A-2112', m:15},
      { n:'A-2113', m:23}, { n:'A-2114', m:21}, { n:'A-2115', m:13}, { n:'A-2116', m:13},
      { n:'A-2117', m:15}, { n:'A-2118', m:15}, { n:'A-2119', m:15}, { n:'A-2120', m:15},
      { n:'A-2121', m:23}, { n:'A-2122', m:15}, { n:'A-2123', m:33}
    ].map((r, i) => ({ id: 206000 + i, blockId: 206, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n:'M-501', m:40}, { n:'M-502', m:34}, { n:'M-503', m:32}, { n:'M-504', m:31},
      { n:'M-505', m:30}, { n:'M-506', m:26}, { n:'M-507', m:20}, { n:'M-508', m:21},
      { n:'M-509', m:26}, { n:'M-510', m:26}, { n:'M-511', m:40}
    ].map((r, i) => ({ id: 300000 + i, blockId: 300, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n:'L-501', m:21}, { n:'L-502', m:22}, { n:'L-503', m:22}, { n:'L-504', m:22},
      { n:'L-505', m:22}, { n:'L-506', m:22}, { n:'L-507', m:22}, { n:'L-508', m:35},
      { n:'L-509', m:35}, { n:'L-510', m:22}, { n:'L-511', m:22}, { n:'L-512', m:22},
      { n:'L-513', m:22}, { n:'L-514', m:22}, { n:'L-515', m:22}, { n:'L-516', m:22}
    ].map((r, i) => ({ id: 301000 + i, blockId: 301, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n:'K-501', m:14}, { n:'K-502', m:15}, { n:'K-503', m:15}, { n:'K-504', m:15},
      { n:'K-505', m:15}, { n:'K-506', m:15}, { n:'K-507', m:15}, { n:'K-508', m:15},
      { n:'K-509', m:15}, { n:'K-510', m:22}, { n:'K-511', m:22}, { n:'K-512', m:22},
      { n:'K-5023', m:10}
    ].map((r, i) => ({ id: 302000 + i, blockId: 302, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n:'H-501', m:7}, { n:'H-502', m:7}, { n:'H-503', m:7}, { n:'H-504', m:7},
      { n:'H-505', m:7}, { n:'H-506', m:7}, { n:'H-507', m:7}, { n:'H-508', m:7}
    ].map((r, i) => ({ id: 303000 + i, blockId: 303, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n:'G-501', m:13}, { n:'G-502', m:12}, { n:'G-503', m:10}, { n:'G-504', m:16},
      { n:'G-505', m:16}, { n:'G-506', m:9},  { n:'G-507', m:9},  { n:'G-508', m:9},
      { n:'G-509', m:10}, { n:'G-510', m:10}, { n:'G-511', m:8},  { n:'G-512', m:8},
      { n:'G-513', m:10}, { n:'G-514', m:10}, { n:'G-515', m:10}
    ].map((r, i) => ({ id: 304000 + i, blockId: 304, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n:'F-501', m:12}, { n:'F-502', m:7},  { n:'F-503', m:12}, { n:'F-504', m:12},
      { n:'F-505', m:14}, { n:'F-506', m:12}, { n:'F-507', m:13}, { n:'F-508', m:12},
      { n:'F-509', m:12}, { n:'F-510', m:12}, { n:'F-511', m:13}, { n:'F-512', m:13},
      { n:'F-513', m:14}, { n:'F-514', m:14}, { n:'F-515', m:14}
    ].map((r, i) => ({ id: 305000 + i, blockId: 305, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n:'E-501', m:16}, { n:'E-502', m:22}, { n:'E-503', m:20}, { n:'E-504', m:20},
      { n:'E-505', m:14}, { n:'E-506', m:12}, { n:'E-507', m:12}, { n:'E-508', m:12},
      { n:'E-509', m:12}, { n:'E-510', m:10}, { n:'E-511', m:10}, { n:'E-512', m:11},
      { n:'E-513', m:11}, { n:'E-514', m:10}, { n:'E-515', m:10}, { n:'E-516', m:20},
      { n:'E-517', m:10}, { n:'E-518', m:10}, { n:'E-519', m:22}
    ].map((r, i) => ({ id: 306000 + i, blockId: 306, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n:'D-501', m:18}, { n:'D-502', m:23}, { n:'D-503', m:20}, { n:'D-504', m:23},
      { n:'D-505', m:18}, { n:'D-506', m:16}, { n:'D-507', m:16}, { n:'D-508', m:15},
      { n:'D-509', m:16}, { n:'D-510', m:16}, { n:'D-511', m:14}, { n:'D-512', m:23}
    ].map((r, i) => ({ id: 307000 + i, blockId: 307, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n:'C-501', m:21}, { n:'C-502', m:16}, { n:'C-503', m:16}, { n:'C-504', m:16},
      { n:'C-505', m:17}, { n:'C-506', m:16}, { n:'C-507', m:16}, { n:'C-508', m:15},
      { n:'C-509', m:16}, { n:'C-510', m:16}, { n:'C-511', m:16}, { n:'C-512', m:16},
      { n:'C-513', m:18}, { n:'C-514', m:17}, { n:'C-515', m:20}, { n:'C-516', m:21},
      { n:'C-517', m:18}, { n:'C-518', m:18}, { n:'C-519', m:20}, { n:'C-520', m:18},
      { n:'C-521', m:18}, { n:'C-522', m:15}, { n:'C-523', m:16}, { n:'C-524', m:16},
      { n:'C-525', m:15}
    ].map((r, i) => ({ id: 308000 + i, blockId: 308, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n:'B-501', m:22}, { n:'B-502', m:17}, { n:'B-503', m:20}, { n:'B-504', m:17},
      { n:'B-505', m:17}, { n:'B-506', m:20}, { n:'B-507', m:17}, { n:'B-508', m:22},
      { n:'B-509', m:18}, { n:'B-510', m:16}, { n:'B-511', m:16}, { n:'B-512', m:17},
      { n:'B-513', m:17}, { n:'B-514', m:17}, { n:'B-515', m:16}, { n:'B-516', m:16},
      { n:'B-517', m:17}, { n:'B-518', m:14}, { n:'B-519', m:18}, { n:'B-520', m:20},
      { n:'B-521', m:17}, { n:'B-522', m:21}, { n:'B-523', m:18}, { n:'B-524', m:20},
      { n:'B-525', m:17}, { n:'B-526', m:17}, { n:'B-527', m:18}
    ].map((r, i) => ({ id: 309000 + i, blockId: 309, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n:'A-501', m:31}, { n:'A-502', m:20}, { n:'A-503', m:29}, { n:'A-504', m:30},
      { n:'A-505', m:31}, { n:'A-506', m:20}, { n:'A-507', m:29}, { n:'A-508', m:31},
      { n:'A-509', m:31}, { n:'A-510', m:28}, { n:'A-511', m:30}, { n:'A-512', m:31},
      { n:'A-513', m:20}, { n:'A-514', m:21}, { n:'A-515', m:24}, { n:'A-516', m:18},
      { n:'A-517', m:18}, { n:'A-518', m:21}, { n:'A-519', m:21}, { n:'A-520', m:22},
      { n:'A-521', m:22}
    ].map((r, i) => ({ id: 310000 + i, blockId: 310, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n: 'F-108', m: 24 }, { n: 'X-102', m: 25 }, { n: 'E-103', m: 22 }, { n: 'X-104', m: 17 },
      { n: 'G-109', m: 29 }, { n: 'X-106', m: 23 }, { n: 'X-107', m: 22 }, { n: 'F-110', m: 21 },
      { n: 'G-108', m: 21 }, { n: 'T-103', m: 23 }, { n: 'R-104', m: 21 }, { n: 'X-112', m: 23 },
      { n: 'X-113', m: 32 }, { n: 'X-114', m: 20 }, { n: 'F-107', m: 22 }, { n: 'G-106', m: 19 },
      { n: 'X-117', m: 20 }, { n: 'X-118', m: 22 }, { n: 'X-119', m: 26 }, { n: 'X-120', m: 26 },
      { n: 'R-104', m: 23 }
    ].map((r, i) => ({ id: 400000 + i, blockId: 400, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n: 'V 101', m: 9 }, { n: 'V 102', m: 15 }, { n: 'V 103', m: 15 }, { n: 'V 104', m: 15 },
      { n: 'V 105', m: 15 }, { n: 'V 106', m: 20 }, { n: 'V 107', m: 15 }, { n: 'V 108', m: 15 },
      { n: 'V 109', m: 41 }, { n: 'V 110', m: 41 }, { n: 'V 111', m: 8 }, { n: 'V 112', m: 10 },
      { n: 'V 113', m: 40 }, { n: 'V 114', m: 15 }
    ].map((r, i) => ({ id: 500000 + i, blockId: 500, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n: 'U 101', m: 13 }, { n: 'U 102', m: 19 }, { n: 'U 103', m: 19 }, { n: 'U 104', m: 19 },
      { n: 'U 105', m: 19 }, { n: 'U 106', m: 19 }, { n: 'U 107', m: 19 }, { n: 'U 108', m: 19 },
      { n: 'U 109', m: 19 }, { n: 'U 110', m: 18 }, { n: 'U 111', m: 18 }, { n: 'U 112', m: 18 },
      { n: 'U 113', m: 18 }, { n: 'U 114', m: 18 }, { n: 'U 115', m: 18 }, { n: 'U 116', m: 18 },
      { n: 'U 117', m: 18 }
    ].map((r, i) => ({ id: 501000 + i, blockId: 501, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n: 'M 101', m: 8 }, { n: 'M 102', m: 8 }, { n: 'M 103', m: 8 }, { n: 'M 104', m: 13 },
      { n: 'M 105', m: 8 }, { n: 'M 106', m: 8 }, { n: 'M 107', m: 8 }, { n: 'M 108', m: 11 },
      { n: 'M 109', m: 8 }, { n: 'M 110', m: 8 }, { n: 'M 111', m: 11 }, { n: 'M 112', m: 11 },
      { n: 'M 113', m: 8 }, { n: 'M 114', m: 15 }, { n: 'M 115', m: 13 }
    ].map((r, i) => ({ id: 600000 + i, blockId: 600, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n: 'N 101', m: 10 }, { n: 'N 102', m: 10 }, { n: 'N 103', m: 28 }, { n: 'N 104', m: 13 },
      { n: 'N 105', m: 10 }, { n: 'N 106', m: 10 }, { n: 'N 107', m: 10 }, { n: 'N 108', m: 10 },
      { n: 'N 109', m: 13 }, { n: 'N 110', m: 13 }, { n: 'N 111', m: 13 }, { n: 'N 112', m: 13 }
    ].map((r, i) => ({ id: 601000 + i, blockId: 601, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n: 'L 101', m: 29 }, { n: 'L 102', m: 29 }, { n: 'L 103', m: 29 }, { n: 'L 104', m: 29 },
      { n: 'T-104 L-105', m: 29 }, { n: 'L 106', m: 29 }, { n: 'L 107', m: 34 }, { n: 'Z-106 Z-108 L-108', m: 35 },
      { n: 'R 102', m: 25 }
    ].map((r, i) => ({ id: 602000 + i, blockId: 602, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n: 'K 101', m: 43 }, { n: 'K 102', m: 21 }, { n: 'K 103', m: 18 }, { n: 'K 104', m: 13 },
      { n: 'K 105', m: 14 }, { n: 'K 106', m: 21 }, { n: 'K 107', m: 18 }, { n: 'K 108', m: 13 },
      { n: 'K 109', m: 18 }, { n: 'K 110', m: 17 }, { n: 'K 111', m: 18 }, { n: 'K 112', m: 15 },
      { n: 'K 113', m: 18 }, { n: 'K 114', m: 15 }, { n: 'K 115', m: 16 }
    ].map((r, i) => ({ id: 700000 + i, blockId: 700, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n: 'I 101', m: 18 }, { n: 'I 102', m: 16 }, { n: 'I 103', m: 18 }, { n: 'I 104', m: 16 },
      { n: 'I 105', m: 16 }, { n: 'I 106', m: 16 }, { n: 'I 107', m: 16 }, { n: 'I 108', m: 15 },
      { n: 'I 109', m: 12 }, { n: 'I 110', m: 28 }, { n: 'I 111', m: 15 }, { n: 'I 112', m: 14 },
      { n: 'I 113', m: 15 }, { n: 'I 114', m: 13 }
    ].map((r, i) => ({ id: 701000 + i, blockId: 701, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n: 'H 101', m: 17 }, { n: 'H 102', m: 17 }, { n: 'H 103', m: 15 }, { n: 'H 104', m: 15 },
      { n: 'H 105', m: 17 }, { n: 'H 106', m: 17 }, { n: 'H 107', m: 15 }, { n: 'H 108', m: 15 },
      { n: 'H 109', m: 17 }, { n: 'H 110', m: 17 }, { n: 'H 111', m: 15 }, { n: 'H 112', m: 15 },
      { n: 'H 113', m: 15 }, { n: 'H 114', m: 15 }
    ].map((r, i) => ({ id: 702000 + i, blockId: 702, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n: 'D 101', m: 20 }, { n: 'D 102', m: 10 }, { n: 'D 103', m: 28 }, { n: 'D 104', m: 14 },
      { n: 'D 105', m: 20 }, { n: 'D 106', m: 20 }, { n: 'D 107', m: 14 }, { n: 'D 108', m: 14 },
      { n: 'D 109', m: 30 }, { n: 'D 110', m: 30 }
    ].map((r, i) => ({ id: 800000 + i, blockId: 800, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n: 'C 101', m: 15 }, { n: 'C 102', m: 32 }, { n: 'C 103', m: 25 }, { n: 'C 104', m: 25 },
      { n: 'C 105', m: 15 }, { n: 'C 106', m: 32 }, { n: 'C 107', m: 25 }, { n: 'C 108', m: 25 },
      { n: 'C 109', m: 32 }, { n: 'C 110', m: 32 }
    ].map((r, i) => ({ id: 801000 + i, blockId: 801, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n: 'B 101', m: 22 }, { n: 'B 102', m: 30 }, { n: 'B 103', m: 15 }, { n: 'B 104', m: 30 },
      { n: 'B 105', m: 20 }, { n: 'B 106', m: 15 }, { n: 'B 107', m: 16 }, { n: 'B 108', m: 16 },
      { n: 'B 109', m: 15 }, { n: 'B 110', m: 15 }, { n: 'B 111', m: 20 }, { n: 'B 112', m: 20 },
      { n: 'B 113', m: 20 }, { n: 'B 114', m: 20 }, { n: 'B 115', m: 20 }, { n: 'B 116', m: 20 }
    ].map((r, i) => ({ id: 802000 + i, blockId: 802, name: r.n, m3: r.m, customerName: null, isReserved: false, paidMonths: [] })),
    ...[
      { n: 'A 101', m: 22 }, { n: 'A 102', m: 20 }, { n: 'A 103', m: 22 }, { n: 'A 104', m: 10 },
      { n: 'A 105', m: 20 }, { n: 'A 106', m: 30 }, { n: 'A 107', m: 22 }, { n: 'A 108', m: 10 },
      { n: 'A 109', m: 25 }, { n: 'A 110', m: 30 }
